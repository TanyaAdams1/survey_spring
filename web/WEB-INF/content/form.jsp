...
<div class="alert alert-info text-center">
    May I require your excellency to fill in a survey below?
</div>
    ...
    <div class="row justify-content-center">
        <div class="col justify-content-center">
            <s:form action="submitAction">
                <s:textfield id="name" name="name" cssClass="form-control" label="Your name" readonly="true"
                             value="%{#session.name}"/>
                <s:textfield id="age" name="age" cssClass="form-control" label="Your age"/>
                <s:select list="#{'Male':0,'Female':1,'Otherwise':2}" listKey="value" listValue="key" id="gender"
                          name="gender" label="Your gender" cssClass="form-control"/>
                <s:token/>
                <s:textfield id="email" name="email" cssClass="form-control" label="Your contact" readonly="true"
...
<div class="alert alert-info">
    Or, you may want to <a href="<s:url action="viewAction"/> ">view the results</a> directly.
</div>
<!-- Optional JavaScript -->
